public class Sender
{
    ...
    public Sender(string name, int senderId, Address address, string email = null, string phone = null)
    {
        this._name = name;
    ...
    public string GetEmail() {
        if (_email == null) {
            Console.WriteLine("Sender Doesn't have a recorded Email. Add Email? (y/n)");
    ...
    public void UpdateAddress (Address address) {
        if (_address.GetAddress == null) {
            Console.WriteLine("Sender has No Listed Address. Add Address? (y/n)");
            string response = Console.ReadLine();
            if (response == "y") {
                this._address = address;
            } else {
    ...
    public void UpdatePhone (string phone) {
        if (_phone == null) {
            Console.WriteLine("Sender has no Listed Phone Number. Add Number? (y/n)");
            string response = Console.ReadLine();
            if (response == "y") {
                this._phone = phone;
            } else {
